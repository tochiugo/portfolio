    ...
    <header className="fixed top-0 inset-x-0 z-50 bg-black/85 backdrop-blur-md md:backdrop-blur-xl border-b border-white/10">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex items-center justify-between h-16">
          <button onClick={() => scrollToSection('top')} className="flex items-center gap-2 group">
          ...
          <button onClick={() => setOpen((o) => !o)} className="xl:hidden p-2 text-zinc-300" aria-label="Menu">
